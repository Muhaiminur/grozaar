class ApiUrl {
  ...
  static const String categoryUrl = "user/get-parent-categories?page=1&par_page=50";
  static const String subCategoryUrl = "user/category/";
  ...
  static const String forgetPasswordUpdateUrl = "forget-password/update";
}
